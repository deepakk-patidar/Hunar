...
public class Constant {
    ...
    // public static String QUIZ_URL = "https://infocentroid.us/HUNAR_SK/api-v2.php/";  //api url
    public static String QUIZ_URL = "https://www.hunarindia.co.in/api-v2.php/";
    ...
    public static int PENALTY = 1;// minus mark for incorrect
