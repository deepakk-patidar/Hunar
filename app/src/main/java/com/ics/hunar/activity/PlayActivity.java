...
import com.ics.hunar.helper.CircleTimer;
import com.ics.hunar.helper.Session;
import com.ics.hunar.helper.TouchImageView;
import com.ics.hunar.helper.Utils;
import com.ics.hunar.model.Question;
...
import static com.ics.hunar.activity.MainActivity.bookmarkDBHelper;
...
/*        if (Session.getBoolean(Session.E_MODE, getApplicationContext()))
        ...
        rightProgress.setMax(count);
        wrongProgress.setMax(count);
...
//            showDialogForCertificate(PlayActivity.this);
//
//        } else
//            level_coin = 0;
